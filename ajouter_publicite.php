...
<head>
    ...
    <title>Ajouter une Publicité - ConseilBox Dashboard</title>
    ...
    <main class="flex-1 p-4 sm:p-8 ml-0 lg:ml-64">
        <div class="max-w-3xl mx-auto">
            <div class="flex items-center mb-6">
                ...
                <h1 class="text-2xl sm:text-3xl font-bold text-gray-800 ml-4">Nouvelle Publicité</h1>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                <form action="actions/_ajouter_publicite.php" method="POST" enctype="multipart/form-data">
                    <div class="p-6 sm:p-8 space-y-8">
                        <div>
                            <label for="title" class="block text-sm font-semibold text-gray-600 mb-1">Titre de la publicité</label>
                        ...
                        <div>
                            <label for="content" class="block text-sm font-semibold text-gray-600 mb-1">Contenu / Description</label>
                        ...
                        <div>
                            ...
                            <input type="url" name="target_url" id="target_url" placeholder="https://example.com"
                                   class="mt-1 block w-full px-4 py-2 bg-gray-50 rounded-lg border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition duration-150 ease-in-out">
                        </div>
                        
                        <div>
                            <label for="image" class="block text-sm font-semibold text-gray-600 mb-1">Image</label>
                            <input type="file" name="image" id="image" class="mt-1 block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100 cursor-pointer transition duration-150 ease-in-out"/>
                        </div>

                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label for="start_date" class="block text-sm font-semibold text-gray-600 mb-1">Date de début</label>
                                <input type="date" name="start_date" id="start_date" class="mt-1 block w-full px-4 py-2 bg-gray-50 rounded-lg border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition duration-150 ease-in-out">
                            </div>
                            <div>
                                <label for="end_date" class="block text-sm font-semibold text-gray-600 mb-1">Date de fin</label>
                                <input type="date" name="end_date" id="end_date" class="mt-1 block w-full px-4 py-2 bg-gray-50 rounded-lg border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition duration-150 ease-in-out">
                            </div>
                        </div>

                        <div class="flex items-center">
                            <input id="is_active" name="is_active" type="checkbox" value="1" checked class="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
                            <label for="is_active" class="ml-3 block text-sm font-semibold text-gray-700">Activer cette publicité dès maintenant</label>
                        </div>
                    </div>
